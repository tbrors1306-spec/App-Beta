    ...
    with geo_tabs[1]:
        ...
        with col_vis:
            if 'calc_res_3d' in st.session_state:
                ...
                fig_3d = Visualizer.plot_rolling_offset_3d_room(res['roll_val'], 0, res['set_val']) # run_length is tough here to visualize without correct math, passed 0
